...
} from "../../utils/cryptography/signers/MultiSignerERC7913WeightedUpgradeable.sol";
import {Initializable} from "@openzeppelin/contracts/proxy/utils/Initializable.sol";

abstract contract AccountMockUpgradeable is
    Initializable,
    Account,
    ERC7739Upgradeable,
    ERC7821,
...
abstract contract AccountECDSAMockUpgradeable is
    Initializable,
    Account,
...
abstract contract AccountP256MockUpgradeable is
    Initializable,
    Account,
...
abstract contract AccountRSAMockUpgradeable is
    Initializable,
    Account,
...
abstract contract AccountWebAuthnMockUpgradeable is
    Initializable,
    Account,
    SignerWebAuthnUpgradeable,
    ERC7739Upgradeable,
    ERC7821,
    ERC721Holder,
    ERC1155Holder
...
abstract contract AccountEIP7702MockUpgradeable is
    Initializable,
    Account,
    SignerEIP7702,
    ERC7739Upgradeable,
    ...
    ERC1155Holder
{
    ...
    function _rawSignatureValidation(bytes32 hash, bytes calldata signature)
        ...
        view
        virtual
        override(AbstractSigner, AccountERC7579Upgradeable, SignerEIP7702)
        returns (bool)
    {
...
abstract contract AccountERC7913MockUpgradeable is
    Initializable,
    Account,
...
abstract contract AccountMultiSignerMockUpgradeable is
    Initializable,
    Account,
