...
const BASE_SHERWOOD = {
  FACTORY: "0x5cBE8269CfF68D52329B8E0F9174F893627AFf0f" as Address,
  GOVERNOR: "0x9a0C8BB6744058Aaf36690EAA9f3fC1d7619F169" as Address,
} as const;

const BASE_SEPOLIA_SHERWOOD = {
  FACTORY: "0xffB15e53360b01fEecb8952Ec4F4e809cB0D4965" as Address,
  GOVERNOR: "0x18Fd69B362E935f52b233bEeD033425C859605C5" as Address,
} as const;

const ROBINHOOD_TESTNET_SHERWOOD = {
  FACTORY: "0x0Fc5367463A5ae2723BAAb45F73EC4B0c21EBD3f" as Address,
  GOVERNOR: "0x143Ee933cCa54C1511518397F51B1A80dF9eEEAb" as Address,
} as const;
